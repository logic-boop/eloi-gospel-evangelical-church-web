...
export default function AboutPage() {
    ...
    return (
        <main className={`transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'} bg-[#050505] text-white selection:bg-[#721422] selection:text-white`}>

            {/* --- 1. HERO SECTION: THE WINE & GOLD MANDATE --- */}
            <section className="relative min-h-[90vh] w-full flex flex-col items-center justify-center overflow-hidden pt-32 px-6 bg-wine">
                <div className="absolute inset-0 z-0 opacity-40">
                    <div className="absolute inset-0 bg-gradient-to-b from-wine via-transparent to-[#050505] z-10"></div>
                    <Image
                        src="/apostle.jpeg"
            ...
            {/* --- 2. THE PRESIDENTIAL PROFILE: CINO & APOSTLE.JPEG --- */}
            <section className="py-40 px-6 bg-[#050505] border-y border-white/5 relative">
                <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                    ...
                    <div className="reveal reveal-left relative group">
                        <div className="relative aspect-[3/4] overflow-hidden border-2 border-wine shadow-[0_0_50px_rgba(114,20,34,0.3)]">
                            <Image
                                src="/apostle.jpeg"
                        ...
                        {/* Imperial Badge */}
                        <div className="absolute -top-10 -left-10 bg-wine p-10 hidden md:block border border-[#C5A059]/30">
                    ...
                    <div className="reveal reveal-right space-y-12">
                        <span className="text-wine font-black uppercase tracking-[0.6em] text-xs">The Set Man</span>
                        ...
                        <div className="space-y-8 text-white/50 text-xl leading-relaxed font-light italic border-l-2 border-wine pl-10">
                            <p>
                        ...
                        <div className="pt-8">
                            <Link href="/about/apostle-famose" className="group flex items-center gap-8">
                                <span className="bg-wine text-white px-12 py-6 font-black uppercase tracking-[0.3em] text-[10px] group-hover:bg-[#C5A059] group-hover:text-black transition-all duration-500">
                                    Read Full Biography
                                </span>
            ...
            {/* --- 3. THE STRATEGIC SYNERGY: CINO, CAFO, WEH, LCJE --- */}
                ...
                <div className="max-w-[1800px] mx-auto">
                    <div className="text-center mb-32">
                        ...
                        <h2 className="reveal reveal-up delay-100 text-6xl md:text-[7vw] font-black uppercase tracking-tighter leading-none">
                            THE <span className="text-wine italic">ALLIANCE.</span>
                        </h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/5">
                        {[
                            { title: "CINO", subtitle: "Presidential Mandate", desc: "Leading the global charge for the restoration and care of the fatherless.", color: "bg-wine" },
                            ...
                            { title: "WEH", subtitle: "Worship Hub", desc: "Creating an atmosphere of encounter where the sound of restoration is birthed.", color: "bg-wine" },
                            ...
                            <div key={i} className={`reveal reveal-up p-16 ${org.color} border border-white/5 hover:scale-[1.02] transition-transform duration-700`}>
                                ...
                                <h4 className="text-4xl font-black uppercase tracking-tighter mb-8">{org.title}</h4>
            ...
            {/* --- 4. FAITH & COVENANT (WINE ACCENT) --- */}
            <section className="py-40 bg-wine px-6 overflow-hidden relative">
                    ...
                    <div className="reveal reveal-right space-y-4">
                        {[
                            ...
                            <div key={i} className="bg-black/20 p-12 border border-white/10 backdrop-blur-sm">
                                <h4 className="text-white font-black text-xl uppercase tracking-widest mb-4">{item.title}</h4>
            ...
            <section className="py-60 bg-[#050505] px-6 text-center border-t border-white/5">
                <div className="max-w-5xl mx-auto relative z-10">
                    <h2 className="reveal reveal-up text-6xl md:text-[10vw] font-black uppercase tracking-tighter leading-[0.8] mb-16">
                        ONE IN A <br /> <span className="text-transparent border-b-2 border-wine italic">MILLION.</span>
                    </h2>
                    <div className="reveal reveal-up delay-200 flex flex-col sm:flex-row gap-8 justify-center items-center">
                        <Link href="/partners" className="bg-wine text-white px-16 py-8 font-black uppercase tracking-[0.4em] text-[10px] hover:bg-[#C5A059] transition-all duration-500">
