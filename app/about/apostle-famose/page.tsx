...
export default function ApostleBiography() {
    ...
    return (
        ...
        <main className={`transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'} bg-[#050505] selection:bg-[#C5A059] selection:text-[#0A192F] overflow-x-hidden`}>
            ...
            <section className="relative h-screen w-full flex items-end overflow-hidden">
                ...
                <div className="relative z-20 w-full max-w-[1800px] px-10 pb-20 md:pb-22">
                    <motion.div
                        initial={{ opacity: 0, letterSpacing: "0.5em" }}
                        animate={{ opacity: 1, letterSpacing: "1.2em" }}
                        /* Sky to Gold */
                        className="text-[#C5A059] font-black uppercase text-[10px] md:text-xs mb-8"
                    >
                    ...
                    <h1 className="reveal reveal-up text-[12vw] md:text-[10vw] font-black text-white uppercase tracking-tighter leading-[0.75] mb-6">
                        MOSES <br /> <span className="text-transparent  italic">FAMOSE.</span>
                    </h1>
            ...
            <section className="py-40 px-8 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                <div className="reveal reveal-left space-y-12">
                    <div className="space-y-4">
                        {/* Wine to Gold */}
                        <span className="text-[#C5A059] font-black text-xs uppercase tracking-[0.5em]">The Calling</span>
                    ...
                    <div className="space-y-10 text-white/60 text-xl font-light italic leading-relaxed border-l-4 border-[#C5A059] pl-12 py-4">
                        <p>
                ...
                <div className="reveal reveal-right relative aspect-[3/4] group">
                    {/* border-wine to border-white/10 */}
                    <div className="absolute -inset-4 border border-white/10 translate-x-8 translate-y-8 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-1000" />
                    {/* bg-wine/10 to bg-[#0A192F] */}
                    <div className="relative h-full w-full overflow-hidden bg-[#0A192F]">
                        <Image
                            src="/apostle.jpeg"
                            alt="The Mantle"
                            fill
                            className="object-cover group-hover:grayscale-0 transition-all duration-[2s]"
                        />
                    </div>
                </div>
            </section>
            ...
            <section className="py-40 bg-[#080808] border-y border-white/5">
                <div className="max-w-[1800px] mx-auto px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
                        ...
                        <h2 className="text-7xl md:text-9xl font-black text-white uppercase tracking-tighter leading-none">THE <br /> <span className="text-[#C5A059]">MANTLE.</span></h2>
                        <div className="max-w-md text-right">
                            ...
                            {/* bg-sky to bg-gold */}
                            <div className="h-px w-32 bg-[#C5A059] ml-auto" />
                        </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/5">
                        {[
                            /* acccents updated: sky to gold, wine to white */
                            { title: "Prophetic Explosion", desc: "Awakening territories through the precision of the Word.", accent: "[#C5A059]" },
                            { title: "CINO Mission", desc: "The apostolic heartbeat for the fatherless and the vulnerable.", accent: "white" },
                            { title: "CAFO Leadership", desc: "Governing the administrative structures of the global move.", accent: "[#C5A059]" },
                            { title: "LCJE Circle", desc: "Equipping commanders for the end-time harvest.", accent: "white" }
                        ].map((pillar, i) => (
                            <div key={i} className="reveal reveal-up bg-[#0A0A0A] p-16 hover:bg-[#111] transition-all duration-700 group">
                                ...
                                <h4 className="text-2xl font-black text-white uppercase mb-6 group-hover:text-[#C5A059] transition-colors">{pillar.title}</h4>
            ...
            {/* bg-wine to bg-[#0A192F] (Deep Blue) */}
            <section className="py-60 px-8 relative overflow-hidden bg-[#0A192F]">
                ...
                <div className="max-w-5xl mx-auto text-center space-y-16 relative z-10">
                    <h2 className="reveal reveal-up text-6xl md:text-9xl font-black text-white uppercase tracking-tighter leading-[0.8]">
                        THE 5% <br /> <span className="text-[#C5A059] italic">COVENANT.</span>
                    </h2>
                    ...
                    <div className="reveal reveal-up flex justify-center pt-20">
                        <div className="w-px h-40 bg-[#C5A059] opacity-40" />
                    </div>
                </div>
            </section>
            ...
            <section className="py-40 px-8 max-w-[1800px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
                    <div className="reveal reveal-up space-y-6">
                        {/* sky to gold */}
                        <h5 className="text-[#C5A059] font-black text-4xl uppercase tracking-tighter">THE VISION</h5>
                    ...
                    <div className="reveal reveal-up delay-100 space-y-6">
                        {/* wine to white */}
                        <h5 className="text-white font-black text-4xl uppercase tracking-tighter">THE VOICE</h5>
                    ...
                    <div className="reveal reveal-up delay-200 space-y-6">
                        {/* white to gold */}
                        <h5 className="text-[#C5A059] font-black text-4xl uppercase tracking-tighter">THE VICTORY</h5>
